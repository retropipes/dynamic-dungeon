...
public class FireWeaponScreen extends TargetBasedScreen {
    public FireWeaponScreen(final Creature thePlayer, final int sx, final int sy) {
	super(thePlayer, "Fire " + thePlayer.nameOf(thePlayer.weapon()) + " at?", sx, sy);
    }
	...
	final var other = this.player.creature(x, y, this.player.z);
	if (other == null) {
