...
public class XMLFileWriter implements AutoCloseable {
    ...
    public void writeDouble(double d) throws IOException {
        this.bw.write("<" + XMLFileConstants.DOUBLE_TAG + ">"
                + Double.toString(d) + "</" + XMLFileConstants.DOUBLE_TAG + ">"
                + XMLFileWriter.END_OF_LINE);
    }

    public void writeInt(int i) throws IOException {
        this.bw.write("<" + XMLFileConstants.INT_TAG + ">" + Integer.toString(i)
                + "</" + XMLFileConstants.INT_TAG + ">" + XMLFileWriter.END_OF_LINE);
    }

    public void writeLong(long l) throws IOException {
        this.bw.write("<" + XMLFileConstants.LONG_TAG + ">" + Long.toString(l)
                + "</" + XMLFileConstants.LONG_TAG + ">"
                + XMLFileWriter.END_OF_LINE);
    }

    public void writeByte(byte b) throws IOException {
        this.bw.write("<" + XMLFileConstants.BYTE_TAG + ">" + Byte.toString(b)
                + "</" + XMLFileConstants.BYTE_TAG + ">"
                + XMLFileWriter.END_OF_LINE);
    }

    public void writeBoolean(boolean b) throws IOException {
        this.bw.write("<" + XMLFileConstants.BOOLEAN_TAG + ">"
                + Boolean.toString(b) + "</" + XMLFileConstants.BOOLEAN_TAG + ">"
                + XMLFileWriter.END_OF_LINE);
    }

    public void writeString(String s) throws IOException {
        this.bw.write("<" + XMLFileConstants.STRING_TAG + ">"
                + XMLFileWriter.replaceSpecialCharacters(s) + "</"
                + XMLFileConstants.STRING_TAG + ">" + XMLFileWriter.END_OF_LINE);
    }

    public void writeOpeningGroup(String groupName) throws IOException {
        this.bw.write("<" + XMLFileWriter.replaceSpecialCharacters(groupName)
                + ">" + XMLFileWriter.END_OF_LINE);
    }
