...
public class XMLFileReader implements AutoCloseable {
    ...
    private static void validateOpeningTag(String tag, String tagType) throws IOException {
	if (!tag.equals("<" + tagType + ">")) {
	    throw new UnexpectedTagException("Expected opening tag of <" + tagType + ">, found " + tag + "!");
	}
    }

    private static void validateClosingTag(String tag, String tagType) throws IOException {
	if (!tag.equals("</" + tagType + ">")) {
